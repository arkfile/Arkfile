...
func TestGetFileMeta_Success(t *testing.T) {
	...
	fileRows := sqlmock.NewRows([]string{"id", "file_id", "storage_id", "owner_username", "encrypted_password_hint", "password_hint_nonce", "encrypted_tags", "tags_nonce", "tags_revision", "password_type", "filename_nonce", "encrypted_filename", "sha256sum_nonce", "encrypted_sha256sum", "encrypted_stream_sha256sum", "encrypted_fek", "size_bytes", "padded_size", "chunk_count", "chunk_size_bytes", "upload_date"}).
		AddRow(int64(1), fileID, "stor-1", username, "", "", "", "", int64(0), "account", "nonce1", "encName1", "shaNonce1", "encSha1", "", "encFek1", int64(5000000), nil, int64(1), int64(16777216), "2024-01-01 12:00:00")
...
func TestGetFileMeta_NotOwner(t *testing.T) {
	...
	fileSQL := `SELECT id, file_id, storage_id, owner_username, COALESCE\(encrypted_password_hint, ''\), COALESCE\(password_hint_nonce, ''\), COALESCE\(encrypted_tags, ''\), COALESCE\(tags_nonce, ''\), COALESCE\(tags_revision, 0\), password_type, filename_nonce, encrypted_filename, sha256sum_nonce, encrypted_sha256sum, COALESCE\(encrypted_stream_sha256sum, ''\), encrypted_fek, size_bytes, padded_size, chunk_count, chunk_size_bytes, upload_date FROM file_metadata WHERE file_id = \?`
	fileRows := sqlmock.NewRows([]string{"id", "file_id", "storage_id", "owner_username", "encrypted_password_hint", "password_hint_nonce", "encrypted_tags", "tags_nonce", "tags_revision", "password_type", "filename_nonce", "encrypted_filename", "sha256sum_nonce", "encrypted_sha256sum", "encrypted_stream_sha256sum", "encrypted_fek", "size_bytes", "padded_size", "chunk_count", "chunk_size_bytes", "upload_date"}).
		AddRow(int64(1), fileID, "stor-1", actualOwner, "", "", "", "", int64(0), "account", "nonce1", "encName1", "shaNonce1", "encSha1", "", "encFek1", int64(1024), nil, int64(1), int64(16777216), "2024-01-01 12:00:00")
	mockDB.ExpectQuery(fileSQL).WithArgs(fileID).WillReturnRows(fileRows)
...
func TestGetFileMeta_UnapprovedUser(t *testing.T) {
	...
	fileSQL := `SELECT id, file_id, storage_id, owner_username, COALESCE\(encrypted_password_hint, ''\), COALESCE\(password_hint_nonce, ''\), COALESCE\(encrypted_tags, ''\), COALESCE\(tags_nonce, ''\), COALESCE\(tags_revision, 0\), password_type, filename_nonce, encrypted_filename, sha256sum_nonce, encrypted_sha256sum, COALESCE\(encrypted_stream_sha256sum, ''\), encrypted_fek, size_bytes, padded_size, chunk_count, chunk_size_bytes, upload_date FROM file_metadata WHERE file_id = \?`
	fileRows := sqlmock.NewRows([]string{"id", "file_id", "storage_id", "owner_username", "encrypted_password_hint", "password_hint_nonce", "encrypted_tags", "tags_nonce", "tags_revision", "password_type", "filename_nonce", "encrypted_filename", "sha256sum_nonce", "encrypted_sha256sum", "encrypted_stream_sha256sum", "encrypted_fek", "size_bytes", "padded_size", "chunk_count", "chunk_size_bytes", "upload_date"}).
		AddRow(int64(1), fileID, "stor-1", username, "", "", "", "", int64(0), "account", "nonce1", "encName1", "shaNonce1", "encSha1", "", "encFek1", int64(1024), nil, int64(1), int64(16777216), "2024-01-01 12:00:00")
	mockDB.ExpectQuery(fileSQL).WithArgs(fileID).WillReturnRows(fileRows)
