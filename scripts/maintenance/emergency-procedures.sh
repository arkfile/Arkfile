...
show_emergency_menu() {
    ...
    echo -e "${NC}"
    echo ""
    echo -e "${YELLOW}[WARNING]  WARNING: These procedures are for emergency situations only${NC}"
    echo -e "${YELLOW}[WARNING]  Some actions are irreversible and will affect all users${NC}"
    echo ""
