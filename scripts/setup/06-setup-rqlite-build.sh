...
# Configuration
VERSION="10.0.0"  # Latest stable version of rqlite
EXPECTED_COMMIT="462a7da2490131e597b33fdce72c4cdc52fe5142"  # Git commit for v10.0.0
BASE_DIR="/opt/arkfile"
CACHE_DIR="/var/cache/arkfile-rqlite-build"
...
setup_source() {
    ...
    #
    # Since CACHE_DIR has been shifted to /var/cache/arkfile-rqlite-build
    # (completely outside /opt/arkfile tree), we no longer have to traverse
    # or touch /opt/arkfile path permissions on-the-fly! This is much more secure.
...
main() {
    ...
    # No /opt/arkfile ownership adjustments needed as we used an external cache directory
