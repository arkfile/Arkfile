...
echo ""
echo "SeaweedFS: S3 gateway on localhost only (TLS not required for local connections)"
echo "           Cert: ${TLS_DIR}/seaweedfs/server.crt"
echo "           Key:  ${TLS_DIR}/seaweedfs/server.key"
echo ""
