...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --legal-entity-name <name>    Legal operator name shown in Terms and Privacy pages"
...
if [ -n "$LEGAL_ENTITY_NAME" ]; then
    ...
    echo "  Legal entity:    (not set - using the operator of localhost)"
fi
