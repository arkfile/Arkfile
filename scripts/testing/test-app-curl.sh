...
phase_9_file_operations() {
    ...
    info "Generating 100MB test file for future verification using cryptocli..."
    
    # Check if cryptocli is available - REQUIRED for file generation and hashing
    ...
    # Generate 100MB test file using cryptocli generate-test-file command
    log "Generating 100MB deterministic test file using cryptocli..."
    ...
    success "Test file generated and SHA256 calculated in single cryptocli operation"
    ...
    success "File operations phase completed using cryptocli"
