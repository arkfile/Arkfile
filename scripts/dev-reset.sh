...
ARKFILE_BTCPAY_SERVER_URL=http://localhost:3000
ARKFILE_BTCPAY_STORE_ID=test_store_id
ARKFILE_BTCPAY_API_KEY=test_api_key
ARKFILE_BTCPAY_WEBHOOK_SECRET=test_webhook_secret
ARKFILE_MIN_TOP_UP_USD=0.50
ARKFILE_MAX_TOP_UP_USD=1000.00

# Subscriptions (Subscription Bridge consumer; mock bridge in e2e)
ARKFILE_SUBSCRIPTIONS_ENABLED=true
ARKFILE_SUBSCRIPTION_BRIDGE_ENABLED=true
ARKFILE_BILLING_PAYG_ENABLED=true
ARKFILE_SUBSCRIPTION_BRIDGE_URL=http://127.0.0.1:8081
ARKFILE_SUBSCRIPTION_BRIDGE_PAIRING_ROOT=000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f
ARKFILE_SUBSCRIPTION_RETURN_URL=https://localhost:8443/?subscription=return
ARKFILE_GIFT_SUBSCRIPTION_DEFAULT_DAYS=30
ARKFILE_GIFT_SUBSCRIPTION_MAX_DAYS=90
ARKFILE_SUBSCRIPTION_PAST_DUE_GRACE_DAYS=7
ARKFILE_SUBSCRIPTION_SEED_DEV_PLAN=true
